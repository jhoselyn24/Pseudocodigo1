var cantidadSucursales = parseInt(prompt("Ingresa el numero de sucursales"))
var totalTienda;
var totalSucursal;
var totalEmpresa = 0;
var separador = "=========================";
...
for (var i = 1; i <= cantidadSucursales; i++) {
	var cantidadTiendas = parseInt(prompt("Ingresa el numero de tiendas de la sucursal " + i))
	totalSucursal = 0;
	for (var j = 1; j <= cantidadTiendas; j++) {
		var cantidadEmpleados = parseInt(prompt("Ingresa el numero de empleados de la tienda " + j + " de la sucursal " + i))
		totalTienda = 0;
